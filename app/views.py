...
from app.models import Admin, Sponsor, Influencer, Campaign
...
def admin_register():
    if request.method == 'POST':
        ...
        new_user = Admin(username=username, email=email)  # Include email
...
def influencer_register():
    if request.method == 'POST':
        ...
        collaboration_type = request.form['collaboration_type']
        ...
        # Create a new influencer with the email
        new_user = Influencer(
...
def sponsor_register():
    if request.method == 'POST':
        username = request.form['username']
        email = request.form['email']  # Ensure this line is present
        password = request.form['password']
        company_name = request.form['company_name']
        website_url = request.form.get('website_url', '')  # Optional field
        ...
        # Create a new user with the email and other fields
        new_user = Sponsor(username=username, email=email, company_name=company_name, website_url=website_url)
        new_user.set_password(password)  # Hash the password
...
def search_campaigns():
    ...
    return render_template('influencer/search_campaign.html')
